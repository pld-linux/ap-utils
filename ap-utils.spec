...
Summary(pl.UTF-8):	Konfiguracja i monitoring punktów dostępu bezprzewodowego (Access Points)
Name:		ap-utils
Version:	1.5
Release:	1
Epoch:		1
...
Konfiguracja i monitoring punktów dostępu (Access Points) dla sieci
bezprzewodowych.
